  ...
  render() {
    return (
      <div className="calls-to-action">
        ...
        <div><a href="mailto:ypsilampshade@gmail.com?subject=Check out my art for Lampshade&body=Attach your art to this message so we can check it out. :)">Send us your art!</a></div>
